...
class ApiCourseheader(models.Model):
    course_url = models.CharField(max_length=100)
    course_tag = models.CharField(primary_key=True, max_length=100)
    course_title = models.CharField(max_length=100, blank=True, null=True)
    rating = models.FloatField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'api_courseheader'


class ApiRelatedCourse(models.Model):
    domain_topic = models.IntegerField(blank=True, null=True)
    score = models.FloatField(blank=True, null=True)
    keyword = models.TextField(blank=True, null=True)
    course_tag = models.OneToOneField(ApiCourse, models.DO_NOTHING, db_column='course_tag', blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'api_related_course'
